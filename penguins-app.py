...
if uploaded_file is not None:
    ...
    def user_input_features():
        ...
        data2['geo_level_2_id'] = [st.sidebar.slider('geo_level_2_id', 0,1427,702)]
...
#geo_level_id_2
#geo_level_id_3
with open('damage1_geo_2.pickle','rb') as read_file31:
    damage1 = pickle.load(read_file31)
with open('damage2_geo_2.pickle','rb') as read_file32:
    damage2 = pickle.load(read_file32)
with open('damage3_geo_2.pickle','rb') as read_file33:
